...
public class Productview implements Initializable {
    ...
    void activation(ActionEvent event) {
    	...
    	if (btnactivation.getText().equals("거래중")) {
    		...
    		ProductDao.productDao.activation(Productcontroller.select.getPnum());
    		Productcontroller.select.setPactivation(2);
    		return;
    	}
    	...
    	if (btnactivation.getText().equals("판매완료")) {
    		...
    		ProductDao.productDao.activation(Productcontroller.select.getPnum());
    		Productcontroller.select.setPactivation(3);
    		return;
    	}
    	...
    	if (btnactivation.getText().equals("판매중")) {
    		...
    		ProductDao.productDao.activation(Productcontroller.select.getPnum());
    		Productcontroller.select.setPactivation(1);
    		return;
    	}
    ...
    void delete(ActionEvent event) {
    	...
    	if (optional.get() == ButtonType.OK) {
    		ProductDao.productDao.delete(Productcontroller.select.getPnum());
    		Home.home.loadpage("/view/product/product.fxml");
    	}
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		Product product = Productcontroller.select;
		// 2. 각 컨트롤에 값 넣기 
		...
		txtmid.setText("제품등록회원 : " + MemberDao.memberDao.getmid(product.getMnum()));
