...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<div style="border-bottom: solid 1px #e3e2e3; border-top: solid 1px #ebe9ea; margin: 0 auto; padding: 5px;">
					<h5 style="font-weight: bold;"> 회원가입 및 정상적인 서비스 이용을 위해 아래 약관을 읽어보시고, <br> 동의 여부를 결정해 주세요. </h5> <br> <h5 style="color: gray;">필수 약관을 동의 하셔야 회원가입이 가능합니다.</h5>
				</div>
				
				<div style="margin-top: 5px;">
					<span style="font-size: 20px;">  회원가입 약관 동의 </span> <span style="color: red; font-size: 20px;">*</span>
				</div>
				<div style="height: 170px; padding:0 20px 20px 20px; overflow-y : auto; width: 98%;box-sizing: border-box;border: 1px solid #ccc; margin: 5px; line-height: 15px;" tabindex="0">
				...
				<p style="margin-top: 20px; margin-bottom: 20px;">
					<input type="checkbox" checked="checked"> 회원가입 약관 동의합니다.
				</p>
				
				<div style="margin-top: 5px;  border-top: solid 1px #e3e2e3; margin: 0 auto; padding: 5px;">
					<span style="font-size: 20px;">  개인정보처리방침 </span> <span style="color: red; font-size: 20px;">*</span>
				</div>
				...
				<div style="height: 170px; padding: 20px; overflow-y : auto; width: 98%;box-sizing: border-box;border: 1px solid #ccc;margin: 10px; line-height: 22px;" tabindex="0">
					...
					1) 공간정보 다운로드, 오픈API 신청 및 활용 등 포털 서비스 제공과 서비스 부정이용 방지를 목적으로 개인정보를 <br>&nbsp;&nbsp;&nbsp;처리합니다.<br>
					...
					① 국가공간정보포털 회원정보(필수): 이름, 이메일(아이디), 비밀번호<br>
				...
				<p style="margin-top: 20px; margin-bottom: 20px;">
					<input type="checkbox" checked="checked"> 개인정보처리방침 동의합니다.
				</p>
